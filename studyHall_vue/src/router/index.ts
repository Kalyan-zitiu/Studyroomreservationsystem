...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        children: [
            {
                path: '/study-operation',
                name: 'study-operation',
                meta: {
                    title: '自习室管理',
                    noAuth: true,
                },
                component: () => import(/* webpackChunkName: "study-operation" */ '../views/study-operation.vue'),
            },
            {
                path: '/study-total',
                name: 'study-total',
                ...
                component: () => import('../views/studyTotal.vue'),
            },
            {
                path: '/study-examine',
                name: 'study-examine',
                ...
                component: () => import('../views/study-examine.vue'),
            },
            {
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "system-menu" */ '../views/study-check.vue'),
            },
            {
                path: '/table',
                name: 'basetable',
